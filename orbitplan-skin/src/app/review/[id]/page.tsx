...
import { ActionPlanFlow } from "@/components/review/action-plan-flow";
  ...
  const renderActionPlanFlowchart = () => {
    ...
    return (
      <ActionPlanFlow
        ...
        deliveryComplete={jiraExecutionState.stage === "complete"}
        deliveryButtonLabel={jiraExecutionState.stage === "complete" && executionHubTab === "jira" ? `View ${selectedTicketFormat.label}` : "Open Execution Hub"}
        ...
        formatActionStatusLabel={formatActionStatusLabel}
        formatActionPriorityLabel={formatActionPriorityLabel}
        onOpenExecutionHub={() => setJiraExportModalOpen(true)}
      />
    );
  };
